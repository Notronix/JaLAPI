...
class AnyConfig
{
    ...
    private ConfigItemExternal DynamicProperties;
    ...
    private List<Rule<PropertyRule>> Rules;
    private List<ConfigButton> Buttons;
    private String SubSource;
    private List<System_Channel_Setting_Property> HeaderAuditValues;
    ...
    public ConfigItemExternal getDynamicProperties() {
        return DynamicProperties;
    }

    public void setDynamicProperties(ConfigItemExternal dynamicProperties) {
    ...
    public List<Rule<PropertyRule>> getRules() {
        return Rules;
    }

    public void setRules(List<Rule<PropertyRule>> rules) {
        Rules = rules;
    }
    ...
    public List<System_Channel_Setting_Property> getHeaderAuditValues() {
        return HeaderAuditValues;
    }

    public void setHeaderAuditValues(List<System_Channel_Setting_Property> headerAuditValues) {
