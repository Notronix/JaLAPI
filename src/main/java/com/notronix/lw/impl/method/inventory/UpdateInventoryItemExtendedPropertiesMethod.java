...
public class UpdateInventoryItemExtendedPropertiesMethod extends AbstractLinnworksAPIMethod<Void>
{
    private List<StockItemExtendedProperty> inventoryItemExtendedProperties;

    @Override
    public String getURI() {
        return "Inventory/UpdateInventoryItemExtendedProperties";
    }
    ...
    public UpdateInventoryItemExtendedPropertiesMethod withInventoryItemExtendedProperties(List<StockItemExtendedProperty> inventoryItemExtendedProperties) {
        this.inventoryItemExtendedProperties = inventoryItemExtendedProperties;
        return this;
    }
}
