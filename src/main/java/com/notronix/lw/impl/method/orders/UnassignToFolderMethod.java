...
public class UnassignToFolderMethod extends AbstractLinnworksAPIMethod<List<UUID>>
{
    ...
    public String getURI() {
        return "Orders/UnassignToFolder";
    }
    ...
    public UnassignToFolderMethod withOrderIds(List<UUID> orderIds) {
        this.orderIds = orderIds;
        return this;
    }
